...
> A clean and simple food ordering & rewards web app — built during my B.Tech first year.

**Foodiezz** is a simple food ordering and rewards web application built during my B.Tech first year.  
It allows users to explore a menu, add items to a cart, register for rewards, and contact the store.
